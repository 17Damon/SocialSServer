...
var root = {
    getMessage: function ({id}) {
        ...
        let params={};
        params.id=id;
        return baseDao('item', 'getItemById', params)
            .then(obj=> {
                console.log(obj);
    ...
    checkUser: function ({id,name,password}) {
        ...
        let params={};
        params.id=id;
        return baseDao('user', 'getUserById', params)
            .then(obj=> {
                if(obj[0].name===name&&obj[0].password===password){
                    params.token=token;
                    return baseDao('user', 'updateTokenById', params)
                        .then(obj=> {
    ...
    getItemList: function ({section}) {
        ...
        return baseDao('item', 'getListBySection', params)
            .then(obj=> {
        ...
        return baseDao('user', 'getUserById', params)
            .then(obj=> {
                if(obj[0].publishtoken===token){
                    ...
                    return baseDao('item', 'insert', params)
                        .then(obj=> {
